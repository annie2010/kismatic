...
var commentMap = map[string][]string{
	...
	"docker_registry.username":                           []string{"If the registry requires authentication provide the username and password below.", "Otherwise leave blank for unauthenticated access."},
	"docker_registry.password":                           []string{"Password for the above username."},
